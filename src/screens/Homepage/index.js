    ...
    <View style={wallet.container}>
      <View
        ...
        <View style={wallet.debit}>
          <Text style={wallet.saldo}>Rp100.000</Text>
        ...
        <View style={{alignItems: 'center'}}>
          <View style={rating.content}>
            ...
            <View style={rating.description}>
              ...
              <Text style={rating.text}>Lowokwaru Malang - Suhat Malang</Text>
              <Text style={rating.text}>18 April 08:00</Text>
            </View>
          </View>
