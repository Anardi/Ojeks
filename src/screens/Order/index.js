  ...
  return (
    <View style={categories.container}>
      <TouchableOpacity
        ...
        <Text style={{...categories.title, color: 'black'}}>Riwayat</Text>
      </TouchableOpacity>
      <TouchableOpacity style={categories.card}>
        <Text style={categories.title}>Terbaru</Text>
      </TouchableOpacity>
      <TouchableOpacity style={categories.card}>
        <Text style={categories.title}>Jadwal</Text>
      </TouchableOpacity>
    </View>
  );
};
  ...
  return (
    <View style={filter.container}>
      <View style={filter.itemContainer}>
        ...
        <TouchableOpacity style={filter.item}>
          <Text style={filter.text}>GoCar</Text>
        </TouchableOpacity>
        <TouchableOpacity style={filter.item}>
          <Text style={filter.text}>GoFood</Text>
        </TouchableOpacity>
        <TouchableOpacity style={filter.item}>
          <View
            style={{
